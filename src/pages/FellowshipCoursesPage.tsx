...
const courses = [
  { title: "Fellowship in Permanent make up and cosmetology", link: "/courses/fellowship/permanent-cosmetology", description: "Comprehensive fellowship across permanent makeup and cosmetology.", image: "/images/courses/000.webp" },
  { title: "Fellowship in Facial Aesthetics, Permanent Make up & Cosmetology", link: "/courses/fellowship/facial-permanent-cosmetology", description: "Integrated program spanning injectables and cosmetology.", image: "/images/courses/1.webp" },
  { title: "Fellowship in Facial Aesthetics", link: "/courses/fellowship/facial-aesthetics", description: "Focused fellowship on facial aesthetic treatments and protocols.", image: "/images/courses/2.webp" },
  { title: "Fellowship in Permanent Make up & Cosmetology, Medical Micropigmentation , Plasma Pen", link: "/courses/fellowship/permanent-micropigmentation", description: "Advanced fellowship with medical micropigmentation and plasma pen.", image: "/images/courses/3.webp" },
  { title: "Fellowship in Facial Aesthetics, Permanent Make up & Cosmetology, Medical Micropigmentation , Plasma Pen", link: "/courses/fellowship/facial-permanent-micropigmentation", description: "Comprehensive cross-discipline fellowship with clinical immersion.", image: "/images/courses/222.jpg" },
];
