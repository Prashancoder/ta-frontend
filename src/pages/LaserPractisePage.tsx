...
const courses = [
  { title: "Fellowship in Permanent make up and cosmetology", link: "/courses/laser-practice/laser-practice-page1", description: "Comprehensive fellowship across permanent makeup and cosmetology.", image: "/images/courses/000.webp" },
  { title: "Fellowship in Facial Aesthetics, Permanent Make up & Cosmetology", link: "/courses/laser-practice/laser-practice-page2", description: "Integrated program spanning injectables and cosmetology.", image: "/images/courses/1.webp" },
];

const LaserPractisePage: React.FC = () => {
  return (
    <>
      <Header />
